  ...
  var SF_PRODUCTS = 
{
  ...
  function initSofaReviewCarousel() {
    ...
    function goTo(index) {
      ...
      // The translateX slide is only needed for the mobile layout. At
      // desktop widths the CSS switches to a stacked grid with opacity-
      // based switching — applying this transform there pushes the
      // correctly-visible slide off-screen.
