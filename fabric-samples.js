(function () {
  ...
  var FABRIC_CATALOG = [
    ...
    { slug: "plush-royal-blue", name: "Plush Royal Blue" },
    { slug: "plush-white", name: "Plush White" },
    { slug: "plush-baby-pink", name: "Plush Baby Pink" },
    { slug: "plush-ice-silver", name: "Plush Ice Silver" },
    { slug: "plush-pebble", name: "Plush Pebble" },
    { slug: "plush-mocca", name: "Plush Mocca" },
    { slug: "plush-emerald-green", name: "Plush Emerald Green" },
    { slug: "plush-duck-egg", name: "Plush Duck Egg" },
    { slug: "plush-camel", name: "Plush Camel" },
    { slug: "plush-teal", name: "Plush Teal" },
    { slug: "plush-plum", name: "Plush Plum" },
    ...
    { slug: "naples-pearl-blue", name: "Naples Pearl Blue" },
    { slug: "naples-cream", name: "Naples Cream" },
    { slug: "naples-sand", name: "Naples Sand" },
    { slug: "naples-mink", name: "Naples Mink" },
    { slug: "naples-seal-grey", name: "Naples Seal Grey" },
    { slug: "naples-slate-grey", name: "Naples Slate Grey" },
    { slug: "naples-charcoal", name: "Naples Charcoal" },
    { slug: "naples-blue", name: "Naples Blue" },
    { slug: "naples-plum", name: "Naples Plum" },
    ...
    { slug: "crushed-velvet-white", name: "Crushed Velvet White" },
    { slug: "crushed-velvet-grey", name: "Crushed Velvet Grey" },
    { slug: "crushed-velvet-camel", name: "Crushed Velvet Camel" },
    { slug: "crushed-velvet-gold", name: "Crushed Velvet Gold" },
    { slug: "crushed-velvet-teal", name: "Crushed Velvet Teal" },
    { slug: "crushed-velvet-denim", name: "Crushed Velvet Denim" },
    { slug: "crushed-velvet-hot-pink", name: "Crushed Velvet Hot Pink" },
    { slug: "crushed-velvet-purple", name: "Crushed Velvet Purple" },
    { slug: "crushed-velvet-plum", name: "Crushed Velvet Plum" },
    { slug: "crushed-velvet-baby-pink", name: "Crushed Velvet Baby Pink" },
    { slug: "chenille-cream", name: "Chenille Cream" },
    { slug: "chenille-mink", name: "Chenille Mink" },
    { slug: "chenille-chocolate", name: "Chenille Chocolate" },
    { slug: "chenille-steel", name: "Chenille Steel" },
    { slug: "chenille-charcoal", name: "Chenille Charcoal" },
    { slug: "chenille-duck-egg", name: "Chenille Duck Egg" },
    { slug: "chenille-teal", name: "Chenille Teal" },
    { slug: "chenille-purple", name: "Chenille Purple" },
    { slug: "chenille-plum", name: "Chenille Plum" },
    { slug: "chenille-red", name: "Chenille Red" },
    { slug: "chenille-black", name: "Chenille Black" },
    { slug: "linoso-sand", name: "Linoso Sand" },
    { slug: "linoso-silver", name: "Linoso Silver" },
    { slug: "linoso-slate-grey", name: "Linoso Slate Grey" },
    { slug: "linoso-charcoal", name: "Linoso Charcoal" },
    { slug: "linoso-truffle", name: "Linoso Truffle" },
    { slug: "linoso-black", name: "Linoso Black" },
    { slug: "linoso-midnight-blue", name: "Linoso Midnight Blue" },
    { slug: "linoso-plum", name: "Linoso Plum" },
    { slug: "boucle-granite", name: "Boucle Granite" },
    { slug: "boucle-dove", name: "Boucle Dove" },
    { slug: "boucle-ivory", name: "Boucle Ivory" },
    { slug: "boucle-truffle", name: "Boucle Truffle" },
    { slug: "grey-naples", name: "Grey Naples" },
    { slug: "sand-naples", name: "Sand Naples" },
    { slug: "silver-naples", name: "Silver Naples" },
    { slug: "black-naples", name: "Black Naples" },
    { slug: "brown-naples", name: "Brown Naples" },
    { slug: "cream-naples", name: "Cream Naples" },
    { slug: "dove", name: "Dove" },
    { slug: "ivory", name: "Ivory" },
